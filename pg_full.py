# Tutorial by github/Coding-with-Adam
...
# for your home PostgreSQL test table (you'll need to create this DB)
app.server.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://gitpod@localhost/products"
